...
`adguard/adguardhome` container publishes any port on the host
(`docker ps`, where the listener belongs to Docker, and a new
AdGuard Home may publish nothing but its setup port 3000), and
