---
sidebar_position: 2
description: Keeping a private mirror of Hostwarden current with
  upstream, and gating production on it.
---
...
turn Actions off in a GitHub mirror, which would otherwise run
Hostwarden's own.
