...
**Devices passed to a VM.** On a Hyper-V host, a device
dismounted from the host belongs to a guest
...
Policy included — rule ID, profile, protocol, local port, remote
