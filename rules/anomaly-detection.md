...
- Trusting an SSH CA or adding a principal the user
  did not request (`TrustedUserCAKeys`, a
  `cert-authority` line, a principals file, an
  `@cert-authority` line): one line admits every
  certificate that CA signs
